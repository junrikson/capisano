...
Public Class frmDaftarKategoriMenu
    ...
    Dim modul As String = "DFTKMENU"
    Dim da As MySqlDataAdapter
    Dim dt As DataTable
    Private Function refreshData()
        Try
            functions.localConnect()
            cmd = New MySqlCommand("Select code as Code, name as Name, details as Details, timestamp as Time, operator as Operator from daftarkategorimenu", functions.localConnection)
    ...
    Private Sub btnAdd_Click(sender As Object, e As EventArgs) Handles btnAdd.Click
        ...
        Else
            Try
                ...
                cmd.CommandText = "insert into daftarkategorimenu (code, name, details, operator, modul) VALUES ('" + txtCode.Text + "', '" + txtName.Text + "', '" + txtDetails.Text + "', '" + variabels.oper + "', '" + modul + "');"
                cmd.ExecuteNonQuery()
    ...
    Private Sub btnDelete_Click(sender As Object, e As EventArgs) Handles btnDelete.Click
        Try
            ...
            cmd.CommandText = "delete from daftarkategorimenu where code = '" & txtCode.Text & "'"
            cmd.ExecuteNonQuery()
    ...
    Private Sub btnUpdate_Click(sender As Object, e As EventArgs) Handles btnUpdate.Click
        Try
            ...
            cmd.Connection = functions.localConnection
            cmd.CommandType = CommandType.Text
            cmd.CommandText = "update daftarkategorimenu set name = '" + txtName.Text + "', details='" + txtDetails.Text + ", operator='" + variabels.oper + "' where code = '" + txtCode.Text + "'"
            cmd.ExecuteNonQuery()
            btnAdd.Text = "Add"
            refreshData()
        Catch ex As MySqlException
